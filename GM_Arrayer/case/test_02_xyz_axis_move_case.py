...
class TestXAxis:
    ...
    def test_01_x_axis_move(self, xyz_axis):
        ...
        pytest.assume(GetKeyword.get_keyword(result, 'msg') == 'success')
    ...
    def test_02_x_axis_read_position(self, xyz_axis):
        ...
        print(result)
        pytest.assume(GetKeyword.get_keyword(result, 'status_code') == 200)
        pytest.assume(GetKeyword.get_keyword(result, 'result') == 295)
    ...
    def test_03_x_axis_home(self, xyz_axis):
        ...
        pytest.assume(GetKeyword.get_keyword(result1, 'msg') == 'success')
        pytest.assume(GetKeyword.get_keyword(result2, 'result') == 0)
...
class TestYAxis:
    ...
    def test_05_y_axis_read_position(self, xyz_axis):
        ...
        pytest.assume(GetKeyword.get_keyword(result, 'status_code') == 200)
        pytest.assume(GetKeyword.get_keyword(result, 'result') == 81)
...
class TestZAxis:
    ...
    def test_08_z_axis_read_position(self, xyz_axis):
        ...
        pytest.assume(GetKeyword.get_keyword(result, 'status_code') == 200)
        pytest.assume(GetKeyword.get_keyword(result, 'result') == 35)
